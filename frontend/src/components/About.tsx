          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="relative group mx-auto max-w-[340px] lg:max-w-none">
                ...
                <div className="absolute -inset-[3px] bg-gradient-to-br from-emerald-400 via-blue-500 to-violet-500 rounded-2xl opacity-30 group-hover:opacity-60 blur-[6px] transition-all duration-500" />
                <div className="absolute -inset-[1.5px] bg-gradient-to-br from-emerald-400 via-blue-500 to-violet-500 rounded-2xl opacity-50 group-hover:opacity-80 transition-all duration-500" />
                ...
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden
                  ...
                  {avatarSrc ? (
                    ...
                    /* Initials fallback — visible, not dark */
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                    ...
                    >
                      <span className={`w-1.5 h-1.5 rounded-full ${
                        isAvailable ? 'bg-emerald-400 animate-pulse' : 'bg-slate-400'
                      }`} />
              ...
              <div className="grid grid-cols-2 gap-3">
                {STATS.map(({ value, suffix, label }) => (
                  <div
                    key={label}
                    className="group relative rounded-xl border border-white/[0.12]
                  ...
                  >
                    ...
                    <div className="text-[10px] text-slate-400 tracking-[0.14em] uppercase font-bold">{label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-7">
              ...
              {/* API fallback notice */}
              {fetchFailed && (
                <p className="text-[11px] text-slate-500 italic px-3 py-2 rounded-lg bg-white/[0.03] border border-white/[0.06]">
              ...
              <div className="space-y-5">
                {paragraphs.map((p, i) => (
                  <p
                    key={i}
                    className="text-slate-200 text-base leading-[1.9] font-normal
                      first-of-type:text-[1.0625rem] first-of-type:text-slate-100
                  ...
                  {HIGHLIGHTS.map(item => (
                    <div
                      ...
                      className="flex items-center gap-3 px-4 py-3 rounded-xl
                        ...
                        hover:bg-white/[0.06] hover:border-emerald-500/20
                        transition-all duration-200 group/item"
                    >
                      <CheckCircle2
                        size={15}
                        className="text-emerald-400 flex-shrink-0
                          group-hover/item:scale-110 group-hover/item:drop-shadow-[0_0_6px_rgba(52,211,153,0.6)]
              ...
              <div className="flex items-center gap-4 px-5 py-4 rounded-xl
                border border-white/[0.10] bg-slate-900/60
                shadow-[0_2px_16px_rgba(0,0,0,0.3)]
                hover:border-emerald-500/25 hover:shadow-[0_0_24px_rgba(52,211,153,0.12)]
                transition-all duration-300">
